...
'<!doctype html>
	<html>
		...
		<body>
			...
			<iframe id="external" name="external" src="http://media1.onswestbrabant.nl:8000/status.xsl"></iframe>
			<script>
	...
	header('Location: http://media1.onswestbrabant.nl:8000/status.xsl');
exit;
}
?>